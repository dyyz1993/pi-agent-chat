...
const SPECIAL_FOLDERS: Record<string, IconSpec> = {
  ...
  ".ion": { icon: FolderCog, color: "text-accent" },
  ".pi": { icon: FolderCog, color: "text-accent" },
...
const EXTENSION_ICONS: Record<string, IconSpec> = {
  ...
  css: { icon: Palette, color: "text-accent" },
  ...
  sass: { icon: Palette, color: "text-accent" },
  scss: { icon: Palette, color: "text-accent" },
