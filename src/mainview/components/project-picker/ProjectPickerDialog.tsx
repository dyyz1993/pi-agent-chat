  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed inset-0 z-[100] items-center justify-center">
        ...
        <div className="relative w-full max-w-4xl h-[70vh] mx-4 bg-gray-900 rounded-xl border border-gray-700/50 shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
