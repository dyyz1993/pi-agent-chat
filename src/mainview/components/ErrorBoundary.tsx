    ...
    return (
      <div className="h-screen flex items-center justify-center bg-white dark:bg-gray-950">
        <div className="text-center max-w-md px-6">
          <div className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">出错了</div>
          <div className="text-gray-500 dark:text-gray-400 text-sm mb-6">页面渲染遇到了问题</div>
          <button
