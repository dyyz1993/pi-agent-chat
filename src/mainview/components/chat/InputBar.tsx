        ...
        <div className="relative h-full flex">
          ...
          <div className="flex shrink-0 py-1.5 pr-1.5 gap-1.5">
            <div className="flex flex-col">
              <button
                onClick={handleClear}
                className={`w-8 h-8 md:w-5 md:h-5 rounded border flex items-center justify-center transition-colors ${hasContent ? "border-border-primary/80 text-text-secondary hover:text-text-primary hover:border-border-secondary hover:bg-surface-hover" : "border-border-primary/50 text-text-tertiary pointer-events-none"}`}
                title={t("clearInput")}
            ...
            <div
              className={`flex flex-col shrink ${expanded ? "gap-1 justify-start" : "gap-1 justify-start"}`}
            >
              <button
                onClick={toggleExpand}
                className="w-8 h-8 md:w-5 md:h-5 rounded border border-border-primary/80 text-text-secondary hover:text-text-primary hover:border-border-secondary hover:bg-surface-hover transition-colors flex items-center justify-center"
              ...
              <button
                ...
                className={`w-8 h-8 md:w-5 md:h-5 rounded border flex items-center justify-center transition-colors ${historyEnabled && hasPrev ? "border-border-primary/80 text-text-secondary hover:text-text-primary hover:border-border-secondary hover:bg-surface-hover" : "border-border-primary/50 text-text-tertiary pointer-events-none"}`}
                title={t("collapse")}
              ...
              <button
                ...
                className={`w-8 h-8 md:w-5 md:h-5 rounded border flex items-center justify-center transition-colors ${historyEnabled && hasNext ? "border-border-primary/80 text-text-secondary hover:text-text-primary hover:border-border-secondary hover:bg-surface-hover" : "border-border-primary/50 text-text-tertiary pointer-events-none"}`}
                title={t("expand")}
