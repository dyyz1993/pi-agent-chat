            ...
            (!sessionReady || !agentReady) && !projectFailed ? (
              ...
              <>
                <div className="flex items-end gap-1.5">
                  ...
                  <div className="flex shrink-0 flex-col items-center justify-end gap-1.5 py-1 px-1.5 max-[768px]:gap-2 max-[768px]:py-1.5">
                    {goalMode ? (
                      <button
                      ...
                      <button
                        disabled
                        className="p-2.5 max-[768px]:p-2 rounded-lg transition-colors flex items-center justify-center bg-status-error/30 text-status-error/50 cursor-not-allowed"
                        title={t("stop")}
                        aria-label={t("stop")}
                      >
                        <Square className="w-4 h-4" />
