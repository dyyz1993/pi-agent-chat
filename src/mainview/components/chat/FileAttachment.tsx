...
function AttachmentPreview({ att, onRemove }: { att: AttachmentFile; onRemove: () => void }) {
  ...
  return (
    <div className="group relative flex items-center gap-1.5 px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-800 border border-gray-300/50 dark:border-gray-700/50 max-w-[200px]">
      ...
      <button
        onClick={onRemove}
        className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-0.5 rounded hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-all shrink-0"
      >
        <X className="w-3 h-3" />
      </button>
    </div>
