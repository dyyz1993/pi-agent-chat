...
export function RightSidebar({ width, overlay }: RightSidebarProps) {
  ...
  if (isIconBar) {
    return (
      <div
        ...
        className="flex flex-col items-center bg-bg-elevated dark:bg-surface-code border-l border-border-secondary overflow-hidden z-20 pt-1"
        style={{ width }}
  ...
  return (
    <div
      data-testid="right-sidebar"
      className={`flex flex-col bg-surface-dim dark:bg-surface-code border-l border-border-secondary overflow-hidden z-20 ${
      ...
      <div className="flex items-center border-b border-border-secondary shrink-0">
        {overlay && (
          <button
            ...
            className="p-1.5 mr-1 rounded hover:bg-surface-hover dark:hover:bg-surface-dim text-text-tertiary hover:text-text-secondary dark:hover:text-text-secondary transition-colors shrink-0"
            title={t("closePanel")}
          >
