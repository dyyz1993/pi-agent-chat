/**
 * L3 extension: learning — verify UI renders with extension loaded.
 *
 * Minimal smoke: page loads without crash when learning extension is active.
...
test.describe("L3 ext · learning", () => {
  test("page loads with learning extension active", async ({ page }) => {
