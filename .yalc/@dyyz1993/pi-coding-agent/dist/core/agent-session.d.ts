...
import { type CallLLMOptions, type ContextUsage, type ExtensionCommandContextActions, type ExtensionErrorListener, type ExtensionMode, ExtensionRunner, type ExtensionUIContext, type InputSource, type ReplacedSessionContext, type SessionStartEvent, type ShutdownHandler, type ToolDefinition, type ToolInfo } from "./extensions/index.ts";
...
import { type ToolOperationsProvider } from "./tools/index.ts";
...
export declare class AgentSession {
    ...
    private _toolOperationsProvider?;
    ...
    private _agentSystemPromptOverride;
    private _currentAgentPaths;
    ...
    private _assertAgentPathAllowed;
    ...
    private _registerMcpTools;
    private _handleMcpConnectionChange;
    ...
    private _createBuiltinTool;
    private _refreshToolRegistry;
    private _createBaseToolDefinitions;
    ...
    previewRollback(targetId: string): Promise<{
        restored: string[];
        deleted: string[];
        skipped: string[];
        dirty: string[];
