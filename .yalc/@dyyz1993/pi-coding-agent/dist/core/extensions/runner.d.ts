...
export declare class ExtensionRunner {
    ...
    private getProjectRootFn;
    private getSessionDataDirFn;
    private getProjectDataDirFn;
    private getCwdDataDirFn;
    private getGlobalDataDirFn;
    private getFileSnapshotManagerFn;
    private respondUIFn;
    ...
    setFileSnapshotManagerFn(fn: () => import("../file-store/file-snapshot-manager.ts").FileSnapshotManager | null): void;
