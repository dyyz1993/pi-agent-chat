...
import { type Api, type KnownProvider, type Model } from "@dyyz1993/pi-ai";
...
export declare function resolveModelAlias(input: string, tierModels?: Record<string, string>): string | undefined;
/**
 ...
 */
export declare function resolveModelScope(patterns: string[], modelRegistry: ModelRegistry, tierModels?: Record<string, string>): Promise<ScopedModel[]>;
