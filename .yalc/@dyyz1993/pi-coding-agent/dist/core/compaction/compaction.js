...
export const PROGRESSIVE_COMPACT_LEVELS = [20000, 10000, 5000];
export function prepareCompaction(pathEntries, settings, overrideKeepRecentTokens) {
    ...
    const keepRecentTokens = overrideKeepRecentTokens ?? settings.keepRecentTokens;
