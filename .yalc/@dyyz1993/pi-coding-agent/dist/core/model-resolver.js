 ...
 */
import { modelsAreEqual } from "@dyyz1993/pi-ai";
...
export function resolveModelAlias(input, tierModels) {
 ...
 */
export async function resolveModelScope(patterns, modelRegistry, tierModels) {
...
export async function findInitialModel(options) {
    const { cliProvider, cliModel, scopedModels, isContinuing, defaultProvider, defaultModelId, defaultThinkingLevel, modelRegistry, tierModels, } = options;
    let model;
