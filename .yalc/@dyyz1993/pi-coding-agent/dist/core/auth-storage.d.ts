 ...
 */
import { type OAuthCredentials, type OAuthLoginCallbacks, type OAuthProviderId } from "@dyyz1993/pi-ai";
...
export declare class AuthStorage {
     ...
     */
    getOAuthProviders(): import("@dyyz1993/pi-ai").OAuthProviderInterface[];
}
export {};
